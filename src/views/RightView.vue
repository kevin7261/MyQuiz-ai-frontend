<script>
   ...
   *
   * 職責：
   * - 依 currentView 渲染對應頁面：試卷、學生弱點分析、建立測試題庫、學生作答分析等
  */
  ...
  export default {
    name: 'RightView',
    components: { ExamPage, StudentWeaknessAnalysisPage, StudentAnswerAnalysisPage, ProfilePage, CreateTestBankPage, UserManagementPage, SystemSettingsPage },
    props: {
