...
const ragQuizForExamButtonDisabled = computed(() => {
  if (props.card?.ragQuizForExamLoading) return true;
  if (cardMarkedForExam.value) return false;
  return (
    String(props.card?.quizUserPromptText ?? '').trim() === ''
      ...
      >
        ...
        >
          <button
            ...
            "
            :disabled="ragQuizForExamButtonDisabled"
