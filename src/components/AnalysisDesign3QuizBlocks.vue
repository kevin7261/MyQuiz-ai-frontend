<script setup>
/**
 * AnalysisDesign3QuizBlocks - 分析頁 design_3 題目區（對齊 ExamDetailPage 追問輪次：Q／A 子區塊直排 gap-3）
 */
...
<template>
  <div class="analysis-design3-quiz-blocks">
    <!-- 子區塊：題目（display:contents 使 Q／A 與標題同列 gap-3，對齊 ExamDetailPage 追問輪次） -->
    <div
