<script setup>
/**
 * 分析頁逐題標題：{單元} > {題型}（對齊 ExamDetailPage 題目標題列；學生作答分析可選右側 person_id）
 */
...
<template>
  <div
    class="d-flex align-items-center justify-content-between gap-3 w-100 min-w-0 mb-0"
    role="heading"
    aria-level="2"
  ...
  >
    ...
    <span
      ...
      class="my-font-md-400 my-color-black text-break flex-shrink-0 text-end mb-0"
    >{{ personIdTrimmed }}</span>
  </div>
</template>
