 ...
 * 帳號、名稱僅供檢視，不可於此頁修改。建立測試題庫使用的 llm_api_key 僅 user_type 1／2 可見與變更。
...
/** 僅系統開發者／課程管理者可設定「建立測試題庫使用的 LLM API Key」 */
        ...
        <div class="col-12 col-lg-10 col-xl-8 col-xxl-6">
          <div class="text-start page-block-spacing">
            ...
            <div v-if="canEditLlmApiKey" class="mb-4">
              <label class="form-label small text-secondary fw-medium mb-1">建立測試題庫使用的 LLM API Key</label>
              <div class="d-flex flex-wrap align-items-center gap-2">
                <div class="flex-grow-1" style="min-width: 0">
                  <input
                    ...
                    placeholder="選填，建立測試題庫時呼叫 LLM 使用"
                    autocomplete="off"
                  >
                </div>
                <button
