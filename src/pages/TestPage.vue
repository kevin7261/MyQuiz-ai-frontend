...
<template>
  <div class="d-flex flex-column bg-body-secondary h-100">
    ...
    <div class="flex-shrink-0 bg-white border-bottom">
      <div v-if="appliedRag" class="px-4 pt-4 pb-1 small text-muted">
    ...
    <div class="flex-grow-1 overflow-auto bg-white p-4">
      ...
      <template v-else-if="appliedRag">
        <div class="bg-body-tertiary rounded text-start p-4 mb-3" :class="{ 'opacity-75': generateDisabled }">
          <div class="h6 fw-semibold text-muted mb-3 pb-2 border-bottom">產生試題與作答</div>
          <p class="form-text text-muted small mb-3">使用已設為「使用中」的 RAG 產生試題（quiz_type=1）。點「新增 quiz」展開區塊。</p>
                ...
                <div class="card mb-3" :class="{ 'mt-4': slotIndex > 1 }">
                  ...
                  <div class="card-body text-start">
                    ...
                    <div class="mb-3">
                      ...
                      <div class="bg-body-secondary border rounded p-2">{{ currentState.cardList[slotIndex - 1].quiz }}</div>
                    </div>
                    <div class="mb-3">
