...
<template>
  <!--
    DesignPage2｜exam_2、create-exam-bank_2 專用 UI 元件參考
    13 個 Tab：每個區塊獨立一頁
  -->
  <div class="design-page-2 d-flex flex-column h-100 overflow-hidden my-bgcolor-gray-4">

    <!-- 頁首 -->
    <header class="flex-shrink-0 my-bgcolor-gray-4 p-4">
      <div class="container-fluid px-0 text-center">
        <p class="my-font-xl-400 my-color-black text-break mb-0">UI 元件參考 2</p>
      </div>
    </header>
    ...
    <!-- 主內文 -->
    <div class="flex-grow-1 overflow-auto my-bgcolor-gray-4 min-h-0">
              ...
              <section class="my-page-block-spacing mb-0">
                <div class="rounded-4 my-bgcolor-gray-3 p-4">
                  ...
                  <header class="design-page-2-detail-bar flex-shrink-0 px-2 py-3 my-bgcolor-gray-4 border-bottom rounded-top">
                    ...
                    <div class="design-page-2-detail-bar__center min-w-0">
                      <input
                        type="text"
                        class="design-page-2-detail-bar__title my-font-lg-400 my-color-black text-truncate text-center w-100 px-3 py-2 rounded-2 mb-0"
                        value="可編輯標題"
                        aria-label="標題"
                      >
                    </div>
                    <div class="design-page-2-detail-bar__end">
                      <button type="button" class="btn rounded-circle d-flex justify-content-center align-items-center flex-shrink-0 my-font-md-400 my-color-gray-1 my-button-transparent-borderless design-page-2-detail-bar__menu-btn lh-1" aria-label="選單">
              ...
              <section class="my-page-block-spacing mb-0">
                <div class="rounded-4 my-bgcolor-gray-3 p-4">
                  ...
                  <div class="d-flex flex-wrap gap-4 align-items-start mb-3">
                    ...
                    <div>
                      <p class="my-font-sm-400 my-color-gray-1 mb-2">純文字列表（exam_2）</p>
                      <ul class="dropdown-menu dropdown-menu-end design-page-2-switch-menu show position-static d-block shadow mt-0">
...
.design-page-2-detail-bar__start { justify-self: start; min-width: 0; }
.design-page-2-detail-bar__center { justify-self: stretch; width: 100%; min-width: 0; }
.design-page-2-detail-bar__title {
  display: block;
...
.design-page-2-detail-bar__title:hover,
.design-page-2-detail-bar__title:focus { background-color: var(--my-color-gray-3, #f5f5f5); outline: none; box-shadow: none; border: none; }
...
.design-page-2-switch-menu > li { display: block; width: 100%; }
.design-page-2-switch-menu .dropdown-item { width: 100%; white-space: nowrap; }
</style>
